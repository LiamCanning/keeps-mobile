    ...
    'exeter-rugby': [
      {
        id: 'heineken',
        name: 'Heineken',
        avatar: 'https://r2-pub.rork.com/attachments/15pxjlx2zfgjief33iilv',
        amount: '£1,200,000',
        type: 'sponsor',
        logo: 'https://r2-pub.rork.com/attachments/15pxjlx2zfgjief33iilv'
      }
    ],
    'british-cycling': [
      {
        id: 'lloyds',
        name: 'Lloyds',
        avatar: 'https://r2-pub.rork.com/attachments/zuff44sm25iadgsyemfcp',
        amount: '£2,500,000',
        type: 'sponsor',
        logo: 'https://r2-pub.rork.com/attachments/zuff44sm25iadgsyemfcp'
      }
    ],
    'ultimate-frisbee': [
      {
        id: 'vktry',
        name: 'VKTRY',
        avatar: 'https://r2-pub.rork.com/attachments/8s36209rgiqsi046otg3h',
        amount: '£1,800,000',
        type: 'sponsor',
        logo: 'https://r2-pub.rork.com/attachments/8s36209rgiqsi046otg3h'
      }
    ]
  };
...
export default function InvestorsScreen() {
  ...
  const asset = [...userAssets, ...completedAssets].find(a => a.id === id);
