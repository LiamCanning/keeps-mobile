...
export default function JamesMitchellProfileScreen() {
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        <View style={styles.profileHeader}>
          <Image 
            source={{ uri: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=200&fit=crop&crop=center' }}
            style={styles.profileImage}
          />
          <View style={styles.profileInfo}>
            <Text style={styles.profileName}>James Mitchell</Text>
            <Text style={styles.profileHandle}>@jamesmitch_nyc</Text>
            ...
            <View style={styles.joinedContainer}>
              ...
              <Text style={styles.joinedText}>Joined January 2023</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.teamsContainer}>
          ...
          <Text style={styles.teamItem}>• New York Yankees</Text>
          <Text style={styles.teamItem}>• Brooklyn Nets</Text>
        ...
        <View style={styles.achievementsContainer}>
          ...
          <View style={styles.achievementItem}>
            ...
            <Text style={styles.achievementText}>Early Adopter</Text>
          </View>
          <View style={styles.achievementItem}>
            <Trophy size={16} color={Colors.accent.gold} />
            <Text style={styles.achievementText}>Community Contributor</Text>
          </View>
          <View style={styles.achievementItem}>
            <Trophy size={16} color={Colors.accent.gold} />
            <Text style={styles.achievementText}>Football Investment Expert</Text>
          </View>
        </View>
