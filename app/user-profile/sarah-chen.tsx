...
export default function SarahChenProfileScreen() {
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        <View style={styles.profileHeader}>
          <Image 
            source={{ uri: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=200&h=200&fit=crop&crop=center' }}
            style={styles.profileImage}
          />
          <View style={styles.profileInfo}>
            <Text style={styles.profileName}>Sarah Chen</Text>
            <Text style={styles.profileHandle}>@sarahc_investor</Text>
            ...
            <View style={styles.joinedContainer}>
              ...
              <Text style={styles.joinedText}>Joined February 2023</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.investmentContainer}>
          ...
          <View style={styles.assetsContainer}>
            ...
            <Text style={styles.assetItem}>• Ultimate Frisbee Association</Text>
          </View>
        </View>
        ...
        <View style={styles.teamsContainer}>
          ...
          <Text style={styles.teamItem}>• Golden State Warriors</Text>
          <Text style={styles.teamItem}>• San Francisco 49ers</Text>
        ...
        <View style={styles.achievementsContainer}>
          ...
          <View style={styles.achievementItem}>
            ...
            <Text style={styles.achievementText}>Motorsport Investment Pioneer</Text>
          </View>
          <View style={styles.achievementItem}>
            <Trophy size={16} color={Colors.accent.gold} />
            <Text style={styles.achievementText}>Tech Sector Specialist</Text>
          </View>
          <View style={styles.achievementItem}>
            <Trophy size={16} color={Colors.accent.gold} />
            <Text style={styles.achievementText}>Community Leader</Text>
          </View>
          <View style={styles.achievementItem}>
            <Trophy size={16} color={Colors.accent.gold} />
            <Text style={styles.achievementText}>High Performance Returns</Text>
          </View>
        </View>
