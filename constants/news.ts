...
export const newsArticles: NewsArticle[] = [
  {
    ...
    content: [
      ...
      'The program enables fans to invest from as little as £500, with Keeps\' innovative platform facilitating the entire process. Early investors have already seen remarkable returns, with the club\'s valuation increasing by 24.5% since the program\'s launch. This growth reflects both Liverpool\'s on-field success and the commercial potential unlocked by direct fan investment.',
      '"Investing in Liverpool via Keeps feels like finally having a real voice in the club\'s future. The transparency and returns are incredible!" shares James Mitchell, a New York-based investor who was among the first to participate in the program.',
  ...
  },
  {
    ...
    url: '#',
    content: [
      'The Ryder Cup debenture program has achieved remarkable success through Keeps Sport, with 90% of the 2,600 available debentures now sold to golf enthusiasts and investors worldwide. This exclusive program offers unprecedented access to one of golf\'s most prestigious events while providing attractive financial returns.',
      ...
      '"The Ryder Cup debenture program through Keeps has been incredible - the access and returns exceed all expectations. Meeting the players and experiencing the tournament from inside is priceless," shares Michael Rodriguez, a Platinum tier debenture holder.',
      'Keeps\' regenerative approach ensures that debenture proceeds directly support tournament infrastructure and player development programs. This model creates lasting value for the sport while providing investors with both financial returns and unforgettable experiences at golf\'s most exciting team competition.'
    ]
  },
  {
    id: '4',
    ...
    content: [
      ...
      'Keeps\' regenerative model will ensure that stadium revenue growth directly benefits both investors and the university\'s athletic programs. This approach creates a sustainable funding mechanism for college sports infrastructure while providing fans with meaningful ownership in their team\'s future success.'
    ]
  },
  {
    id: '5',
    ...
    content: [
      ...
      'Keeps\' regenerative finance model will ensure that investor dividends are reinvested into player development, stadium improvements, and community programs. This approach creates a sustainable growth cycle that benefits the club, its supporters, and the broader Cardiff community while providing attractive returns to investor-fans.'
    ]
  },
  {
    id: '6',
    ...
    content: [
      ...
      'The regenerative finance model pioneered by Keeps ensures that fan investment creates sustainable value for sports organizations while providing attractive returns. This approach is reshaping the sports industry by aligning fan passion with financial opportunity, creating stronger connections between supporters and their teams.'
    ]
  },
  {
    id: '7',
