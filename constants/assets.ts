...
export const completedAssets: Asset[] = [
  {
    ...
    raiseAmount: '£5,000,000 Equity Raise',
    minimumEntry: '£500',
    pricePerShare: 500,
  ...
  },
  {
    ...
    investorReturn: 'Guaranteed premium access to Tour of Britain',
    progress: 100,
    raisedAmount: '£10,000,000',
    goalAmount: '£10,000,000',
    investorCount: 4200,
    growthPercentage: 22.8,
    dividendPotential: '5% + Access',
  ...
  },
  {
    ...
    status: 'FUNDING COMPLETE',
    raiseAmount: '£8,000,000 Equity Raise',
    minimumEntry: '£250',
    pricePerShare: 250,
